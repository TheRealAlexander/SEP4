...
void set_uart_baud_rate(uint32_t baud_rate) {
    uint16_t baud_prescale = (F_CPU / (16UL * baud_rate)) - 1;

    // Temporarily disable the transmitter and receiver , We dont want to corrupt our data
